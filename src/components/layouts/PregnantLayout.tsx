                    ...
                    <SidebarFooter className="border-t border-gray-100 bg-white p-3">
                        <div className="mb-2 flex items-center gap-2.5 rounded-xl bg-gray-50 px-3 py-2.5">
                            ...
                            <div className="min-w-0">
                                <p className="truncate text-xs font-bold text-gray-800">Maria Silva</p>
                ...
                <main className="flex flex-1 flex-col overflow-y-auto min-w-0">
                    ...
                    <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-gray-100 bg-white/90 px-3 sm:px-6 backdrop-blur-md">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <span className="rounded-full border border-pink-200 bg-pink-50 px-2 sm:px-2.5 py-0.5 text-[0.6rem] font-bold uppercase tracking-widest text-pink-500">
                                Gestante
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2">
                            ...
                            {/* User trigger — avatar only em mobile, completo em desktop */}
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    {/* Mobile: só avatar */}
                                    <button className="flex items-center gap-2.5 rounded-full border border-gray-100 bg-white shadow-sm transition-all hover:border-pink-200 hover:shadow-md py-1.5 pl-1.5 pr-1.5 sm:pr-3">
                                        ...
                                        <ChevronDown className="hidden sm:block h-3.5 w-3.5 text-gray-300" />
                                    </button>
                                </DropdownMenuTrigger>
